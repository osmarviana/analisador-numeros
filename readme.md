...
Ferramenta criada para receber valores e salvar numa array para depois entregar ao usuário algumas informações sobre os valores e a array.

### Objetivo

O projeto foi criado para praticar alguns conceitos básicos de JavaScript como variáveis, array, funções, eventos DOM, laços de repetição e estruturas condicionais.
